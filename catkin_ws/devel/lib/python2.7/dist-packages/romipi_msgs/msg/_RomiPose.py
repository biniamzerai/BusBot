...
"""autogenerated by genpy from romipi_msgs/RomiPose.msg. Do not edit."""
import sys
...
class RomiPose(genpy.Message):
  _md5sum = "3d8b91b3b0ff7649c81277385280f189"
  _type = "romipi_msgs/RomiPose"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """# observer saw target at pose relative to observer
...
float64 w
"""
  __slots__ = ['observer_name','target_name','pose']
  _slot_types = ['string','string','geometry_msgs/PoseStamped']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(RomiPose, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.observer_name is None:
        self.observer_name = ''
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.observer_name = str[start:end].decode('utf-8')
      else:
        self.observer_name = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
